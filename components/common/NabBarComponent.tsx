...
//       { title: "Team", url: "/about/team", description: "" },
//     ],
//   },
//   {
//     title: "Our Pillars",
//     url: "#",
//     items: [
//       { title: "CodeFACTORY", url: "/our-pillars/code-factory", description: "" },
//       { title: "TalentFACTORY", url: "/our-pillars/talentFactory", description: "" },
//       { title: "CapitalFACTORY", url: "/our-pillars/capitalFactory", description: "" },
//       { title: "DigitalFACTORY", url: "/our-pillars/digitalFactory", description: "" },
//       { title: "AcceleratorFACTORY", url: "/our-pillars/acceleratorFactory", description: "" },
//     ],
//   },
//   { title: "News", url: "/news" },
...
//   return (
//     <header className="fixed left-10 right-10 top-0 z-50 rounded-lg border-b bg-white shadow-sm">
...
//           <AccordionTrigger className={cn("py-3 text-base font-medium hover:no-underline", linkClassName)}>
//             {item.title}
//           </AccordionTrigger>
