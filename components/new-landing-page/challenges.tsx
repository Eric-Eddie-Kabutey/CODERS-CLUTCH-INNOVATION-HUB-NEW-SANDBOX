      ...
      <div className="w-full rounded-3xl px-6 sm:px-8 md:px-12 lg:px-16 bg-[#0b2027] space-y-16 md:space-y-28 py-12 md:py-16">
        ...
        <div className="bg-[#0F3F35] mb-16 md:mb-20 rounded-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
          <div className="p-6 sm:p-12 md:p-16 flex flex-col justify-center space-y-6 md:space-y-8">
            ...
            <Link
              href="/services"
              className="inline-block border border-white rounded-full px-4 sm:px-6 md:px-4 py-2 sm:py-3 text-xs sm:text-sm md:text-base font-medium hover:bg-white hover:text-[#0F3F35] transition w-60 text-center"
            >
              Validate your ideas
            </Link>
