...
function Challenges() {
  return (
    <section className="mx-auto p-6 sm:p-10 bg-[#f3fef2] text-white">
      {/* Inner container with responsive padding and height */}
      <div className="w-full rounded-4xl px-4 sm:px-8 md:px-12 lg:px-16 bg-[#0b2027] space-y-16 md:space-y-28 py-12 md:py-16">
        ...
        {/* Solutions Section */}
        <div className="bg-[#f3fef2] text-black rounded-3xl shadow-lg p-6 sm:p-12 md:p-16 space-y-8 md:space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
            ...
            <div className="border-b border-black/10 pb-4 md:border-b-0 md:border-r md:pr-6">
              <h4 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3">Product Strategy</h4>
              <p className="text-gray-800 mb-3 sm:mb-4 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed">
            ...
            <div className="border-b border-black/10 pb-4 md:border-b-0 md:border-r md:px-6">
              <h4 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3">Product Design</h4>
              <p className="text-gray-800 mb-3 sm:mb-4 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed">
            ...
            <div className="pb-4 md:pl-6">
              <h4 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3">Product Development</h4>
              <p className="text-gray-800 mb-3 sm:mb-4 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed">
        ...
        {/* Product Lab */}
        <div className="bg-[#0F3F35] mb-16 md:mb-20 rounded-3xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
          <div className="p-6 sm:p-12 md:p-16 flex flex-col justify-center space-y-6 md:space-y-8">
            <h4 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-2">Product Lab</h4>
            ...
            <Link
              href="/services"
              className="inline-block border border-white rounded-full px-4 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm md:text-base font-medium hover:bg-white hover:text-[#0F3F35] transition"
            >
              Validate your ideas
            </Link>
          </div>
