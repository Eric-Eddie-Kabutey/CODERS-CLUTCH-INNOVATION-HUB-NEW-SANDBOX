// components/ImpactReportHeroSection.tsx
"use client";
...
export function ImpactReportHeroSection() {
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-8 md:mb-10">
            Our Impact reports showcase our resilience and consistency at what
            we do. Showing you our works tells more about who we are.
          </p>
          {/* Button */}
